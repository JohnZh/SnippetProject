...
import com.john.newtest.databinding.ActivityTestAidlBinding;
...
public class TestAidlActivity extends AppCompatActivity {
    ...
    private ActivityTestAidlBinding mBinding;
    private PeopleAidl mPeopleAidl;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mBinding = ActivityTestAidlBinding.inflate(LayoutInflater.from(this));
            ...
            public void onClick(View v) {
                if (mPeopleAidl != null) {
                    try {
                        ...
                        if (list.isEmpty()) {
                            Toast.makeText(TestAidlActivity.this, "Empty list, add People", Toast.LENGTH_SHORT).show();
